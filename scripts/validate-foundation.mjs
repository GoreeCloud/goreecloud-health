...
const checks = [
  ...
  [platform.includes("schema_version: '0.3'"), 'Platform Contract 0.3 schema must be declared'],
  [platform.includes("platform_contract: '0.3'"), 'Platform Contract compatibility target must be 0.3'],
  [platform.includes("version: '1.3.0'"), 'Verified Health Glaze source implementation must remain recorded as 1.3.0 until migration occurs'],
  [platform.includes("glaze_ui_required: '1.4.1'"), 'Current Stable GLAZE UI 1.4.1 compatibility target must be recorded'],
  ...
  [platform.includes('sync:\n    result: applicable-blocked\n    version: null'), 'GoreeCloud Sync must be evaluated explicitly and remain blocked until accepted runtime evidence exists'],
