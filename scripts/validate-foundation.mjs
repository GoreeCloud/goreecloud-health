...
const checks = [
  ...
  [readme.includes('activity.active-time'), 'README must record the active-time source contract'],
  ...
  [recordContract.includes('activity.active-time'), 'Record contract must document the active-time boundary'],
  [recordContract.includes('stage-less sessions remain valid'), 'Record contract must preserve missing sleep-stage data'],
  [recordContract.includes('time-ordered and non-overlapping'), 'Record contract must document sleep-stage interval invariants'],
  ...
  [reconciliation.includes('"activity.active-time"'), 'Reconciliation policy must bind the active-time type'],
